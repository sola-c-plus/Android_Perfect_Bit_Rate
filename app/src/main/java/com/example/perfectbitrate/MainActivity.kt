...
class MainActivity : AppCompatActivity() {
    ...
    private fun showDevPresetsDialog() {
        ...
        val devSwitchMsSpatial = view.findViewById<androidx.appcompat.widget.SwitchCompat>(R.id.devSwitchMsSpatial)
        val devSwitchDynamicSbr = view.findViewById<androidx.appcompat.widget.SwitchCompat>(R.id.devSwitchDynamicSbr)
        devSwitchMsSpatial?.setOnCheckedChangeListener { _, isChecked -> NativeAudioEngine.nativeSetMsSpatial(isChecked) }
        devSwitchDynamicSbr?.setOnCheckedChangeListener { _, isChecked -> NativeAudioEngine.nativeSetDynamicSbr(isChecked) }
        ...
        devSwitchDynamicSbr?.isChecked = shouldSwOn
        NativeAudioEngine.nativeSetMsSpatial(shouldSwOn)
        NativeAudioEngine.nativeSetDynamicSbr(shouldSwOn)
